...
const MortgageCalculatorPage = () => {
  ...
  return (
    <div className="font-lexend">
      ...
      <section id="mortgage-calculator-section" className="bg-gradient-to-b from-[#e5f6ff] to-white pt-30 md:pt-40 pb-10 md:pb-16 lg:pb-20 relative overflow-hidden">
