          ...
          <div className="text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-12">
              <a
                ...
                className="w-full sm:w-48 flex items-center justify-center gap-2 bg-white text-primary px-8 py-4 rounded-xl hover:bg-white/90 transition-all duration-200 text-base font-medium shadow-lg hover:shadow-xl active:scale-[0.98]"
              >
