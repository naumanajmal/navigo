...
export const services = [
  ...
  },
  {
    ...
    list_sub_title: 'Global Property Financing',
    ...
    benefits: {
      title: 'Benefits of Choosing Navigo:',
      items: [
        'Expert Advice on Foreign Markets: Navigo provides expert advice to help non-residents navigate local property laws, taxes, and regulations, ensuring compliance.',
        'Access to International Lenders: Navigo works with a broad network of international lenders to offer competitive rates for non-resident mortgages.',
        'Flexible Loan Terms: Mortgages for non-residents come with flexible loan options, including long repayment terms and competitive interest rates.',
        'Ease of Application: Navigo simplifies the application process for non-residents, ensuring a smooth mortgage experience despite geographical and financial challenges.',
        'High Loan-to-Value Ratios: Non-residents can often secure favorable loan-to-value (LTV) ratios, helping them borrow a larger sum relative to the property value.',
        'Tax Planning and Financial Structuring: Navigo assists in structuring loans in a way that minimizes taxes and optimizes financial outcomes for international buyers.'
      ]
    },
    eligibility: {
      title: 'Eligibility:',
      items: [
        'Non-Resident Status: The applicant must reside outside of the country in which the property is being purchased.',
        'Income Proof: Evidence of stable income or assets to demonstrate the ability to repay the loan.',
        'Deposit Requirements: Non-residents typically need to provide a higher deposit (around 30% or more).',
        'Credit History: A good credit score from the applicant\'s home country or internationally recognized credit agencies is required.'
      ]
    },
    faqs: [
      {
        question: 'Can I apply for a mortgage if I am not a resident of the country?',
        answer: 'Yes, non-residents can apply for mortgages in many countries, though specific terms and conditions may apply.'
      },
      {
        question: 'Do I need to be present in the country to apply for a non-resident mortgage?',
        answer: 'No, it is not necessary to be physically present in the country during the application process. Much of the process can be handled remotely.'
      },
      {
        question: 'How much deposit is required for a non-resident mortgage?',
        answer: 'Non-residents typically need to provide a larger deposit, usually around 30% or more, depending on the lender and country.'
      },
      {
        question: 'Are interest rates higher for non-residents?',
        answer: 'Interest rates for non-resident mortgages can be slightly higher compared to resident mortgages, but Navigo helps secure the most competitive rates available.'
      },
      {
        question: 'Can I get a mortgage for an investment property as a non-resident?',
        answer: 'Yes, non-residents can obtain mortgages for investment properties, and Navigo can guide you through the process.'
      },
      {
        question: 'Are there any tax benefits for non-resident mortgage holders?',
        answer: 'Tax benefits depend on the local jurisdiction. Navigo can help identify any tax advantages that may apply to your mortgage.'
      }
    ],
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    benefits: {
      title: 'Benefits of Choosing Navigo:',
      items: [
        'Better Interest Rates: Refinancing allows you to take advantage of lower interest rates, potentially reducing monthly payments.',
        'Lower Monthly Payments: Extending the loan term or securing better rates can significantly reduce monthly payment burdens.',
        'Debt Consolidation: Refinancing allows you to consolidate multiple debts into a single loan, simplifying your finances and potentially lowering your total interest payments.',
        'Improved Loan Terms: Refinancing can help you adjust the loan terms, such as opting for a fixed rate or a different repayment schedule, depending on your financial situation.',
        'Cash-Out Option: If your home has appreciated in value, you may be able to take out additional funds for other financial goals, such as renovations or investments.',
        'Expert Guidance: Navigo\'s experienced professionals guide you through the entire refinancing process, ensuring you make the best decision for your financial future.'
      ]
    },
    eligibility: {
      title: 'Eligibility:',
      items: [
        'Existing Mortgage: You must have an existing mortgage or loan that you wish to refinance.',
        'Property Value: The property\'s value should be sufficient to secure the new loan.',
        'Credit Score: A good credit score is important to qualify for better refinancing terms.',
        'Stable Income: Proof of income to demonstrate repayment ability.'
      ]
    },
    faqs: [
      {
        question: 'What is the difference between refinancing and a balance transfer?',
        answer: 'Both terms refer to taking out a new loan to replace an existing one, but refinancing typically involves adjusting loan terms, while a balance transfer refers to moving debt from one lender to another for better rates.'
      },
      {
        question: 'How much can I save by refinancing my mortgage?',
        answer: 'The amount you can save depends on the interest rate, loan terms, and the remaining balance of your current loan. Refinancing could save thousands over the life of the loan.'
      },
      {
        question: 'Is refinancing available for all types of loans?',
        answer: 'Yes, refinancing options are available for various types of loans, including mortgages, personal loans, and auto loans.'
      },
      {
        question: 'How long does it take to refinance a loan?',
        answer: 'The refinancing process typically takes 2-4 weeks, depending on the complexity of the loan and the documentation required.'
      },
      {
        question: 'What fees are involved in refinancing?',
        answer: 'There may be closing costs, application fees, and other charges associated with refinancing, but these can be outweighed by the savings from lower interest rates.'
      },
      {
        question: 'Can I refinance if I have bad credit?',
        answer: 'Refinancing with bad credit may be challenging, but Navigo can help explore alternative options that suit your credit profile.'
      }
    ],
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    id: 10,
    title: 'UAE/GCC Nationals',
    picture: 'UAE_GCC_National.jpg',
    list_sub_title: 'Specialized Mortgage Services',
    ...
    benefits: {
      title: 'Benefits of Choosing Navigo:',
      items: [
        'Favorable Terms: UAE/GCC nationals are often eligible for preferential mortgage rates, lower down payments, and flexible repayment plans.',
        'Local Market Expertise: Navigo has in-depth knowledge of the UAE and GCC property markets, helping nationals invest smartly in both local and international properties.',
        'Streamlined Approval Process: The approval process is simplified for UAE/GCC nationals, ensuring faster application and approval timelines.',
        'Tailored Solutions: Navigo offers customized mortgage options based on the unique financial landscape of UAE/GCC nationals.',
        'Tax Benefits: Mortgages for UAE/GCC nationals often come with specific tax incentives and rebates, especially when purchasing residential properties.',
        'Property Ownership Guidance: Navigo assists with understanding local property laws and regulations, ensuring a smooth transaction for nationals.'
      ]
    },
    eligibility: {
      title: 'Eligibility:',
      items: [
        'UAE/GCC Nationality: Only UAE or GCC nationals can apply for these mortgages.',
        'Stable Income: Proof of income for the past 6-12 months from a reliable source (employment, business, or investments).',
        'Property Type: The property type (residential, commercial) and its location should comply with local lending regulations.',
        'Age: Applicants typically need to be between 21 and 65 years old.'
      ]
    },
    faqs: [
      {
        question: 'What are the eligibility requirements for UAE/GCC nationals?',
        answer: 'UAE/GCC nationals need to provide proof of nationality, stable income, and may need to show a clean credit history. The property type and its location also play a key role in eligibility.'
      },
      {
        question: 'Can I buy property abroad with a mortgage as a UAE/GCC national?',
        answer: 'Yes, UAE/GCC nationals can apply for international mortgages, and Navigo can help you secure financing for properties in countries around the world.'
      },
      {
        question: 'Are interest rates different for UAE/GCC nationals?',
        answer: 'Yes, UAE/GCC nationals typically benefit from lower interest rates due to their strong economic standing and the preferential treatment they receive from lenders.'
      },
      {
        question: 'What is the maximum loan amount for UAE/GCC nationals?',
        answer: 'The maximum loan amount can vary based on the property’s value and the applicant’s income. Typically, it can go up to 80-90% of the property value.'
      },
      {
        question: 'Can I apply for a mortgage if I am self-employed in the UAE/GCC?',
        answer: 'Yes, self-employed UAE/GCC nationals are eligible, but they may need to provide additional documents such as tax returns, business accounts, and proof of business viability.'
      },
      {
        question: 'How long does it take to process a mortgage application for a UAE/GCC national?',
        answer: 'The application process typically takes between 2 to 4 weeks, depending on the complexity of the case and the required documentation.'
      }
    ],
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    id: 11,
    title: 'Mega Loans',
    picture: 'megaloan.jpg',
    list_sub_title: 'Large-Scale Financing Solutions',
    ...
    benefits: {
      title: 'Benefits of Choosing Navigo:',
      items: [
        'Access to Large Capital: Navigo provides access to multi-million-dollar loans, empowering clients to pursue significant investments or projects.',
        'Competitive Rates: Despite the large sums involved, Navigo helps secure the best interest rates available in the market.',
        'Flexible Terms: Loan structures can be tailored to suit the client’s financial capacity and repayment preferences.',
        'Expert Advice: Navigo offers strategic financial advice to ensure that the loan is used efficiently and the client achieves their investment goals.',
        'Fast Approval: Navigo’s extensive network of lenders and financial institutions helps expedite the approval process for large loans.',
        'Risk Management: With experience in large financing, Navigo assists clients in managing risks related to currency fluctuations, market shifts, and repayment plans.'
      ]
    },
    eligibility: {
      title: 'Eligibility:',
      items: [
        'High Net-Worth Individuals or Established Businesses: Applicants must demonstrate the financial ability to manage large loans.',
        'Strong Financial History: A solid credit history, including high income, assets, and business stability.',
        'Project or Acquisition Details: Clear plans for how the loan will be used (property development, business expansion, etc.).',
        'Collateral Requirements: High-value assets or properties may be required as collateral.'
      ]
    },
    faqs: [
      {
        question: 'What is considered a mega loan?',
        answer: 'A mega loan typically refers to loans that exceed several million dollars and are used for large-scale investments or acquisitions, such as purchasing commercial properties, business expansions, or funding massive development projects.'
      },
      {
        question: 'What collateral is required for a mega loan?',
        answer: 'Collateral requirements vary depending on the loan size and type. High-value properties, investments, or business assets are commonly used as collateral to secure a mega loan.'
      },
      {
        question: 'What types of projects can be financed with a mega loan?',
        answer: 'Mega loans can be used for a wide range of projects, including real estate development, large business expansions, mergers and acquisitions, and other capital-intensive ventures.'
      },
      {
        question: 'Are interest rates higher for mega loans?',
        answer: 'Interest rates for mega loans are generally lower than for smaller loans, as they are often secured by substantial collateral. However, rates depend on the specific project and the borrower’s financial standing.'
      },
      {
        question: 'Can I get a mega loan if I’m not a resident of the country?',
        answer: 'Yes, non-residents can secure mega loans, particularly if they have significant assets and a solid financial history. Navigo can help with navigating the specific requirements.'
      },
      {
        question: 'How long does it take to process a mega loan?',
        answer: 'Processing a mega loan typically takes longer than standard loans due to the extensive due diligence, financial analysis, and negotiations involved. The process can take 4 to 8 weeks, depending on the complexity.'
      }
    ],
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    list_sub_title: 'Unlock Your Property Value',
    ...
    benefits: {
      title: 'Benefits of Choosing Navigo:',
      items: [
        'Unlock Your Property’s Value: Equity release allows you to access the cash tied up in your home, providing financial flexibility.',
        'No Monthly Repayments: With many equity release options, no monthly repayments are required, as the loan is typically repaid when the homeowner moves into long-term care or passes away.',
        'Stay in Your Home: The homeowner can remain living in the property while still accessing the equity.',
        'Tax-Free Cash: The money released through equity release is generally tax-free, providing financial relief without the burden of additional tax obligations.',
        'Flexible Usage: The funds from equity release can be used for various purposes, including home improvements, paying off debts, or enhancing retirement funds.',
        'Professional Advice: Navigo provides expert guidance to ensure clients understand all the risks and benefits associated with equity release.'
      ]
    },
    eligibility: {
      title: 'Eligibility:',
      items: [
        'Age: Generally, the applicant must be at least 55 years old (depending on the type of equity release).',
        'Property Type: The property must be residential and in good condition.',
        'No Outstanding Mortgage: Typically, the property should be mortgage-free or have a low outstanding mortgage balance.',
        'Residency: The applicant must be a resident of the country in which the equity release product is being offered.'
      ]
    },
    faqs: [
      {
        question: 'What is equity release?',
        answer: 'Equity release allows homeowners to access the equity (value) in their home without having to sell the property. The loan is typically repaid when the homeowner passes away or moves into long-term care.'
      },
      {
        question: 'Who is eligible for equity release?',
        answer: 'Generally, homeowners aged 55 and older are eligible for equity release. The property should be residential, and the homeowner should not have a significant mortgage balance remaining.'
      },
      {
        question: 'What are the different types of equity release?',
        answer: 'The two main types are a lifetime mortgage (where you borrow against the value of your property) and a home reversion plan (where you sell part of your property in exchange for a lump sum).'
      },
      {
        question: 'Do I need to repay the equity release loan monthly?',
        answer: 'No, most equity release plans do not require monthly repayments. The loan and interest are repaid when the homeowner sells the property, moves into care, or passes away.'
      },
      {
        question: 'Can I still leave an inheritance if I use equity release?',
        answer: 'Yes, but it may reduce the value of the inheritance, as the loan, including any accumulated interest, will be deducted from the property sale proceeds. Navigo can help structure plans to maximize the inheritance for your loved ones.'
      },
      {
        question: 'How does equity release affect my estate?',
        answer: 'Equity release reduces the value of your estate as the loan, including any accumulated interest, will be repaid upon your death or if you move into long-term care. However, this depends on the type of equity release product you choose.'
      }
    ],
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    benefits: {
      title: 'Benefits of Choosing Navigo:',
      items: [
        'Tailored Loan Solutions: Navigo provides customized land loan options that cater to the unique needs of land buyers, whether for development, personal use, or investment.',
        'Competitive Rates: Secure affordable rates for land purchases, which may be higher due to the nature of the asset but are competitive in the market.',
        'Flexible Terms: Navigo offers flexibility in terms of loan amount, repayment schedules, and down payment to suit your financial capacity.',
        'Expert Advice: Navigo assists with navigating legalities and zoning regulations associated with land acquisition, ensuring that you make informed decisions.',
        'Easy Approval Process: With an extensive network of financial institutions, Navigo helps streamline the land loan approval process, ensuring quicker turnaround times.',
        'Investment Opportunities: Land is often a strong investment, and Navigo’s expertise ensures clients select land with the potential for long-term appreciation.'
      ]
    },
    eligibility: {
      title: 'Eligibility:',
      items: [
        'Property Type: The land should be designated for the intended use (residential, commercial, agricultural).',
        'Location: The location of the land must comply with local zoning and land-use regulations.',
        'Down Payment: A higher down payment is generally required compared to home loans, usually around 20-30% of the land value.',
        'Income: Proof of stable income to ensure repayment capacity.',
        'Creditworthiness: A good credit history is typically necessary.'
      ]
    },
    faqs: [
      {
        question: 'Can I use a land loan for agricultural land?',
        answer: 'Yes, land loans can be used for agricultural purposes, provided that the land is zoned for agricultural use and complies with local regulations.'
      },
      {
        question: 'What is the minimum down payment required for a plot or land loan?',
        answer: 'The down payment typically ranges from 20% to 30% of the land value, depending on the type of loan and the lender.'
      },
      {
        question: 'Are interest rates higher for land loans than for residential mortgages?',
        answer: 'Yes, land loans often carry higher interest rates due to the perceived higher risk associated with land as collateral.'
      },
      {
        question: 'Can I use the loan to develop the land after purchasing it?',
        answer: 'Some loans may offer development options or allow you to finance development costs as part of the loan. Navigo can assist in structuring a loan to suit your needs.'
      },
      {
        question: 'Can I get a land loan if I am a non-resident?',
        answer: 'Yes, non-residents can apply for land loans, provided they meet the financial criteria and the land is within a location where international buyers are permitted to purchase.'
      },
      {
        question: 'How long does the approval process take for land loans?',
        answer: 'The approval process typically takes 3-6 weeks, depending on the complexity of the loan and the documentation provided.'
      }
    ],
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    picture: 'Project_Finance.webp',
    list_sub_title: 'Property Development Financing',
    ...
    benefits: {
      title: 'Benefits of Choosing Navigo:',
      items: [
        'Tailored Payment Plans: Navigo offers flexible payment schedules, allowing you to make payments in stages as construction progresses.',
        'Competitive Interest Rates: By securing the loan during the construction phase, buyers may benefit from lower interest rates compared to fully developed property loans.',
        'Property Value Appreciation: Purchasing property during construction allows buyers to lock in a lower price, potentially leading to higher returns once the property is completed.',
        'Transparent Process: Navigo ensures the process is transparent by working closely with developers and providing clear information on milestones and payments.',
        'Professional Support: Navigo assists in selecting reputable developers and reviewing construction agreements, helping you make informed decisions.',
        'Access to Specialized Lenders: Navigo connects clients with lenders who specialize in under-construction loans, securing the best terms for each project.'
      ]
    },
    eligibility: {
      title: 'Eligibility:',
      items: [
        'Project Progress: The construction project must be registered with the relevant authorities and should have a clear timeline for completion.',
        'Income Proof: Applicants need to provide proof of steady income to ensure repayment capacity.',
        'Property Developer Approval: The developer must be reputable, and their project must meet legal and regulatory standards.',
        'Down Payment: Typically, a 10-25% down payment is required at the time of loan approval.',
        'Credit Score: A good credit score is often required, though some lenders may be flexible.'
      ]
    },
    faqs: [
      {
        question: 'What is an under-construction loan?',
        answer: 'An under-construction loan is a loan used to finance the purchase or construction of a property that is not yet complete. Payments are made in stages based on the construction progress.'
      },
      {
        question: 'How is the loan disbursed?',
        answer: 'The loan is disbursed in stages based on the construction progress, typically linked to milestones set by the developer (e.g., foundation, structure completion, finishing).'
      },
      {
        question: 'Can I get a loan if the property is still in the planning phase?',
        answer: 'Generally, the property must already be under construction or have completed a certain phase of development to qualify for an under-construction loan.'
      },
      {
        question: 'What happens if the construction is delayed?',
        answer: 'Delays in construction may affect the repayment schedule. It\'s important to ensure that the developer has a clear timeline and penalty clauses for delays.'
      },
      {
        question: 'Do I need to make full payments upfront?',
  ...
  },
  {
    ...
    benefits: {
      title: 'Benefits of Choosing Navigo:',
      items: [
        'Simplified Payments: Consolidating multiple loans into one reduces the complexity of managing various payment dates, interest rates, and lenders.',
        'Better Interest Rates: By consolidating your portfolio, Navigo helps you secure a more competitive interest rate than what you\'re currently paying across multiple loans.',
        'Lower Monthly Payments: With a consolidated loan, you may be able to reduce your monthly payments, improving your cash flow.',
        'Debt Reduction Strategy: Navigo provides strategic advice on reducing overall debt by restructuring loan terms, repayment schedules, and interest rates.',
        'Improved Financial Overview: Consolidating allows you to better track your financial progress, helping you make informed decisions about future investments or payments.',
        'Expert Support: Navigo offers professional guidance throughout the entire consolidation process, ensuring that clients receive the best terms and optimal outcomes.'
      ]
    },
    eligibility: {
      title: 'Eligibility:',
      items: [
        'Multiple Loans: Applicants must have multiple outstanding loans, such as personal loans, mortgages, or business debts, that they wish to consolidate.',
        'Income Stability: Proof of stable income is required to ensure repayment ability after consolidation.',
        'Good Credit History: A solid credit score increases the chances of approval and favorable terms.',
        'Sufficient Collateral: In some cases, consolidation may require securing the loan with assets or properties.'
      ]
    },
    faqs: [
      {
        question: 'What is portfolio consolidation?',
        answer: 'Portfolio consolidation is the process of merging multiple loans or debts into a single loan to simplify repayments, reduce interest rates, and make financial management easier.'
      },
      {
        question: 'Can I consolidate both secured and unsecured loans?',
        answer: 'Yes, portfolio consolidation can include both secured loans (e.g., mortgages) and unsecured loans (e.g., personal loans, credit card debt).'
      },
      {
        question: 'How does consolidation affect my credit score?',
        answer: 'Consolidating your debts can improve your credit score if it reduces your debt-to-income ratio and ensures timely repayments. However, missing payments during the consolidation process may negatively impact your credit score.'
      },
      {
        question: 'Can I consolidate loans from different lenders?',
        answer: 'Yes, portfolio consolidation often involves combining loans from different lenders into one single loan with a new interest rate and repayment schedule.'
      },
      {
        question: 'Is it possible to consolidate loans if I have bad credit?',
        answer: 'It may be more challenging to consolidate loans with bad credit, but Navigo can work with you to explore available options and help you improve your credit score.'
      },
      {
        question: 'Will consolidating my loan save me money?',
        answer: 'Consolidation can save money by reducing the interest rate and extending the loan term, which may lower monthly payments. However, it\'s important to evaluate whether the new loan term is favorable in the long run.'
      }
    ],
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    benefits: {
      title: 'Benefits of Choosing Navigo:',
      items: [
        'Sharia-Compliant Products: Navigo offers a range of financing options that are fully compliant with Islamic law, ensuring ethical and responsible financing.',
        'Alternative to Conventional Loans: Islamic finance provides an ethical alternative to traditional interest-based loans, making it appealing to Muslim clients.',
        'Flexible Financing Solutions: Navigo offers a range of Islamic finance structures, including Murabaha, Ijarah, and Musharakah, to cater to different client needs.',
        'Transparency: Islamic finance products emphasize transparency in contracts, ensuring clients understand all terms, fees, and obligations without hidden charges.',
        'Ethical Investment Opportunities: Islamic finance prohibits investments in industries that conflict with ethical values, ensuring that your investment aligns with your personal beliefs.',
        'Experienced Advisors: Navigo provides expert guidance to ensure that all Islamic finance products meet your financial objectives while adhering to Sharia principles.'
      ]
    },
    eligibility: {
      title: 'Eligibility:',
      items: [
        'Sharia Compliance: The financing must comply with Islamic law, which prohibits interest and investments in unethical industries.',
        'Income Requirements: Applicants need to show proof of a stable income or assets.',
        'Purpose of Financing: The purpose of the loan or investment must align with Sharia principles (e.g., no investment in alcohol, gambling, etc.).',
        'Good Credit History: Although Islamic finance doesn\'t involve interest, a good credit history may still be necessary for some types of financing.'
      ]
    },
    faqs: [
      {
        question: 'What is Islamic finance?',
        answer: 'Islamic finance refers to financial products and services that comply with Islamic law (Sharia), which prohibits interest and certain types of investments (e.g., in alcohol, gambling, etc.).'
      },
      {
        question: 'Can I get a mortgage through Islamic finance?',
        answer: 'Yes, Islamic finance provides home financing options, such as Murabaha (cost-plus financing), which allows you to buy a property without paying interest.'
      },
      {
        question: 'What is Murabaha in Islamic finance?',
        answer: 'Murabaha is a contract where the lender buys a property on behalf of the borrower and sells it to them at an agreed-upon price, which includes a profit margin.'
      },
      {
        question: 'Is Islamic finance more expensive than conventional finance?',
        answer: 'Islamic finance may seem more expensive initially due to the profit margins in place of interest. However, the long-term cost can be lower as it avoids the negative effects of interest accumulation.'
      },
      {
        question: 'Can Islamic finance be used for business financing?',
        answer: 'Yes, Islamic finance can be used for business financing through structures such as Musharakah (partnership) and Ijarah (leasing), providing ethical funding for business ventures.'
      },
      {
        question: 'Are Islamic finance products only available to Muslims?',
        answer: 'While Islamic finance products are designed to comply with Sharia law, they are available to anyone who prefers ethical and interest-free financing, regardless of religion.'
      }
    ],
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
