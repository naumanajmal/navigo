      ...
      <section className="relative h-[100vh] bg-black pt-20">
        ...
        <div className="relative z-20 h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="h-full flex items-center justify-between">
            ...
            <div className="w-full max-w-xl text-white">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <a 
                  ...
                  className="flex items-center justify-center gap-2 bg-secondary text-white px-8 py-4 rounded-xl hover:bg-primary/90 transition-colors text-base font-medium shadow-lg"
                >
            ...
            <FloatingQuoteButton onClick={() => setShowMobileForm(true)} />
